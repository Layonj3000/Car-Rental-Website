...
<body>
    <div class="container">
        ...
        <div class="links">
            <a href="../../views/area-publica/index.php">Ir para a Página Inicial</a>
            <a href="../../views/area-publica/showRoom.php">Ver Nossa Frota de Carros</a>
            <a href="../../views/area-publica/fale-conosco.php">Fale Conosco</a>
        </div>
    </div>
    <div class="credit">
