...
<head>
    ...
    <link rel="stylesheet" href="../estilos/estilo-404.css">
...
<body>
    <div class="container">
        ...
        <div class="links">
            <a href="/locadora-de-veiculos/views/index.php">Ir para a Página Inicial</a>
            <a href="/locadora-de-veiculos/views/visualizacaoVeiculos.php">Ver Nossa Frota de Carros</a>
            <a href="/locadora-de-veiculos/views/fale-conosco.php">Fale Conosco</a>
        </div>
    </div>
    <div class="credit">
